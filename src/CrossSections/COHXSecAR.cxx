      ...
      const XSecAlgorithmI * model, const Interaction * in) const
{
  ...
  double xsec = 0;
  if (fSplitIntegral) {
    utils::gsl::wrap::dXSec_dElep_AR * func =
      new utils::gsl::wrap::dXSec_dElep_AR(model, interaction, fGSLIntgType, fGSLRelTol, fGSLMaxEval);
    ...
    ROOT::Math::IBaseFunctionMultiDim * func = 
          new utils::gsl::wrap::d4Xsec_dEldThetaldOmegapi(model, interaction);
    double kine_min[4] = { Elep_min, zero , zero    , zero};
    double kine_max[4] = { Elep_max, pi   , twopi   , pi  };
