...
class AREikonalSolution: public ARWFSolution
{
  ...
  private:
    ...
    ARSampledNucleus* Nucleus() { return nucleus_; }
    ...
    //std::complex<double>  RG20C(const double A, const double B, const unsigned int N, const std::complex<double>  CF[]);
    
    AlvarezRusoCOHPiPDXSec* parent_;
    ARSampledNucleus* nucleus_;
